          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full">
            ...
            >
              ...
              <motion.h1 variants={fadeIn} className="text-5xl lg:text-7xl font-bold leading-tight tracking-tight drop-shadow-2xl transform-gpu">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-red-400">أصباغ GCI</span>
              </motion.h1>
              ...
              <motion.div variants={fadeIn} className="grid grid-cols-3 gap-6 pt-10 border-t border-white/10 transform-gpu">
                <div>
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full h-full max-w-md mx-auto">
                  ...
                  <div className="absolute inset-0 bg-white/10 rounded-[2.5rem] transform -rotate-3 border border-white/20 glass shadow-2xl overflow-hidden flex flex-col backdrop-blur-md">
                    <div className="p-10 border-b border-white/10 flex-grow font-arabic">
                      <Palette className="w-14 h-14 text-white mb-8" />
                      <h3 className="text-2xl font-bold text-white mb-4">تكنولوجيا الألوان الذكية</h3>
                      <p className="text-gray-200 text-lg leading-relaxed mb-8 opacity-80">ابتكارات GCI توفر لك ألواناً تدوم طويلاً ومقاومة للبكتيريا والعوامل الجوية المتغيرة.</p>
                      <ul className="space-y-4">
                        {["مقاومة فائقة للرطوبة", "قابلية للغسل بامتياز", "تغطية ممتازة من الوجه الأول"].map((feature, i) => (
                          <li key={i} className="flex items-center gap-3 text-white text-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
              حلول متكاملة لجميع احتياجات الطلاء والديكور، مصممة بأعلى معايير الجودة العالمية ومواكبة لأحدث صيحات الموضة.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div 
                ...
                className="bg-white rounded-3xl p-8 shadow-xl shadow-brand-navy/5 hover:shadow-2xl transition-all duration-500 border border-gray-100 group cursor-pointer transform-gpu"
                style={{ willChange: "transform, opacity" }}
              >
                <div className={`w-20 h-20 rounded-2xl flex items-center justify-center mb-8 transition-all duration-500 shadow-lg ${cat.color} group-hover:text-white group-hover:scale-110`}>
                ...
                >
                  اكتشف المزيد <ArrowLeft className="w-5 h-5 rtl:rotate-180 group-hover:translate-x-[-4px] transition-transform" />
                </Link>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="relative py-32 bg-brand-navy overflow-hidden">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-12 text-blue-100/80 max-w-3xl mx-auto font-light leading-relaxed">
            تواصل مع خبرائنا اليوم للحصول على استشارة مجانية وعرض سعر مخصص لمتطلبات مشروعك بأفضل جودة وأنسب سعر.
          </p>
          <Link 
            href="/contact" 
          ...
          >
            تواصل معنا الآن <ArrowLeft className="w-6 h-6 mr-4 rtl:rotate-180" />
          </Link>
        </motion.div>
      </section>
