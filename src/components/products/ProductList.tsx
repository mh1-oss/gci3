        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12 font-arabic">
          ...
          <div className="relative w-full md:w-72">
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent text-gray-900 placeholder:text-gray-400"
            />
