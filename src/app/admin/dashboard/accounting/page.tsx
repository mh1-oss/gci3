  ...
  return (
    <div className="space-y-6 font-arabic">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Link href="/admin/dashboard/accounting/new" className="flex items-center gap-2 bg-brand-red text-white px-4 py-2 rounded-xl hover:bg-red-700 transition w-full sm:w-auto justify-center">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-right min-w-[800px] lg:min-w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              {allQuotes.length === 0 && (
                <tr>
                  <td colSpan={7} className="py-10 text-center text-gray-500">لم يتم إنشاء أي عروض أسعار بعد.</td>
                </tr>
              )}
            </tbody>
          </table>
