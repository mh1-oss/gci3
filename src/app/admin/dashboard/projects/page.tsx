    ...
    <div className="space-y-6 font-arabic">
      <div className="flex justify-between items-center">
        ...
        <Link 
          ...
          className="flex items-center gap-2 bg-brand-red text-white px-4 py-2 rounded-xl hover:bg-red-700 transition shadow-lg"
        >
            ...
            {allProjects.map((project) => (
              <tr key={project.id} className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4">
                  <div className="w-20 h-20 rounded-xl bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-50 shadow-sm">
                    {project.imageUrl ? (
                ...
                <td className="px-6 py-4">
                  <div className="font-bold text-brand-navy text-lg">{project.title}</div>
                  <div className="text-sm text-gray-500 line-clamp-1 max-w-md">{project.description || "لا يوجد وصف"}</div>
